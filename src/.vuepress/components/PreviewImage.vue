...
function zoomFunc() {
  const imgElm = document.getElementById('dbPreviewBox-img');
...
function ImageBoxReset() {
  const boxElm = document.getElementById('dbPreviewBox');
...
<template>
  <ClientOnly>
    ...
    >
      ...
      <div class="dbPreviewBox-idxView">
        <div class="dbPreviewBox-idxView-box">
          <div class="dbPreviewBox-idxView-idx">{{ CurrentImgIdx + 1 }}/{{ ImageArr.length }}</div>
          <div class="dbPreviewBox-idxView-alt" v-if="ImageArr[CurrentImgIdx].alt">
...
#dbPreviewBox {
  ...
  .dbPreviewBox-idxView-idx {
    font-size: 24px;
  }
  .dbPreviewBox-idxView-alt {
    margin-top: 10px;
    font-size: 20px;
  }
}
